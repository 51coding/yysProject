...
(function () {
    ...
    function change($1,$2) {
        $1.stop(true,false);
        $2.stop(true,false);
        $1.addClass("hide").delay(500).queue(function () {
           $2.removeClass("hide");
        });
    }
...
(function(){
    ...
    //改变this指向为window，为了作用域之外能访问banner对象
    window.Banr = Banr;
    window.Banr2 = Banr2;
})();
//banner
...
/*(function () {
    var $banner  = $("#news").find(".banner"),
        ...
        $tabLi.mouseenter(function () {
            ...
            var $this = $(this);
            timeout = setTimeout(function () {//定时器设置延迟防止划入过快
                index = $this.index();
                $this.addClass("on").siblings().removeClass("on");
